...
import { productFallbackImage } from '@/utils/productCatalog';
    ...
    >
      ...
      >
        ...
        <div className="relative aspect-square overflow-hidden bg-soft">
          <img
            src={product.images[0] || productFallbackImage(product)} onError={(e) => fallbackProductImage(e, product)}
            alt={product.name}
            loading="lazy"
...
function fallbackProductImage(e: React.SyntheticEvent<HTMLImageElement>, product: Product) { e.currentTarget.onerror = null; e.currentTarget.src = productFallbackImage(product); }
