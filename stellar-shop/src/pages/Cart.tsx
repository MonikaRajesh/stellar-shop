...
import { Trash2, Minus, Plus, Gift, Tag, Truck, ShoppingBag, ArrowRight, X, MessageCircle } from 'lucide-react';
...
import { cartOnWhatsApp } from '@/utils/whatsapp';
        ...
        <div className="lg:sticky lg:top-24 lg:self-start space-y-4">
          <div className="rounded-card border border-base bg-elevated p-5">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              onClick={() => cartOnWhatsApp(activeItems, total)}
              disabled={activeItems.length === 0}
            >
              <MessageCircle className="h-4 w-4" /> Order through WhatsApp
            </Button>
            <p className="mt-2 text-center text-xs text-muted">Send your cart to WhatsApp for manual order confirmation.</p>
          </div>
