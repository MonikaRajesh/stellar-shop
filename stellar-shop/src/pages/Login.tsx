    ...
    <div className="mx-auto flex max-w-md flex-col px-4 py-12 lg:px-6">
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="rounded-card border border-base bg-elevated p-8 shadow-soft">
        ...
        <div className="mt-6 grid grid-cols-2 gap-2">
          ...
          <Button type="button" variant="outline" disabled={busy} onClick={() => void socialLogin('linkedin_oidc')} className="w-full justify-center gap-2"><FaLinkedinIn /> LinkedIn</Button>
          <Button type="button" variant="outline" disabled={busy} onClick={() => void socialLogin('github')} className="w-full justify-center gap-2"><FaGithub /> GitHub</Button>
          <Button type="button" variant="outline" disabled={busy} onClick={() => void socialLogin('azure')} className="w-full justify-center gap-2"><FaMicrosoft /> Microsoft</Button>
        </div>
        ...
        <div className="mt-5 rounded-xl bg-soft p-3 text-xs text-muted"><p className="flex items-center gap-2 font-semibold text-base"><ShieldCheck className="h-4 w-4" /> Secure social authentication</p><p className="mt-1">Google, LinkedIn, GitHub and Microsoft authentication is handled by Supabase OAuth. No OTP is used.</p></div>
