...
export function Register() {
  ...
  const submit=async(e:React.FormEvent)=>{
    ...
    dispatch(addToast({message:'Account created. Check your email for the 6-digit verification code.',type:'success'}));
  ...
  return <div className="mx-auto flex max-w-md flex-col px-4 py-12 lg:px-6"><motion.div initial={{opacity:0,y:16}} animate={{opacity:1,y:0}} className="rounded-card border border-base bg-elevated p-8 shadow-soft">
    <div className="text-center"><div className="mx-auto grid h-12 w-12 place-items-center rounded-2xl gradient-stellar text-white"><Sparkles className="h-6 w-6"/></div><h1 className="mt-4 text-2xl font-bold">Create your account</h1><p className="mt-1 text-sm text-muted">Verify your email before your first login.</p></div>
    ...
    <p className="mt-4 text-center text-sm text-muted">A 6-digit email OTP will be required before sign-in.</p>
