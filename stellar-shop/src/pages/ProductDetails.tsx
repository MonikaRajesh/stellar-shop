...
import {
  Heart, GitCompare, ShoppingCart, Zap, Check, Truck, RotateCcw, Shield, MessageCircle,
  ChevronRight, Minus, Plus, Star, ThumbsUp, ChevronDown,
} from 'lucide-react';
import { productBySlug, products, formatINR, discountPercent } from '@/data/products';
    ...
    <div className="mx-auto max-w-7xl px-4 py-6 lg:px-6">
      ...
      <div className="mt-4 grid gap-8 lg:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-2 text-center text-xs text-muted">Opens WhatsApp with a pre-filled order request.</p>
