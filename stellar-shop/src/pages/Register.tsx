      ...
      const message = code === 'ACCOUNT_EXISTS'
        ...
        : code === 'USERNAME_EXISTS'
          ...
          : code === 'SERVER_AUTH_NOT_CONFIGURED'
            ? 'Sign-up is not configured on the server. Add SUPABASE_SERVICE_ROLE_KEY in Vercel Environment Variables.'
            : code === 'EMAIL_CONFIRMATION_REQUIRED'
              ? 'Account created, but automatic sign-in failed. Please try signing in.'
              : code === 'PROFILE_LOOKUP_FAILED'
                ? 'Unable to check the username right now. Please try again.'
