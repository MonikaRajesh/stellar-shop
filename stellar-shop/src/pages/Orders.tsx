                ...
                <div className="border-t border-base p-4">
                  ...
                  <div className="mt-4 grid gap-2 sm:grid-cols-2">
                    <div className="rounded-lg bg-soft p-3 text-sm">
                      <div className="flex items-center justify-between gap-2"><p className="flex items-center gap-1.5 font-semibold"><MapPin className="h-4 w-4 text-muted" /> Address</p><button type="button" onClick={(e) => { e.stopPropagation(); if (o.status !== 'Processing') { dispatch(addToast({ message: 'This order has already been shipped or completed. Its delivery address cannot be changed.', type: 'error' })); return; } setEditingAddressOrder(o); }} className="inline-flex items-center gap-1 rounded-lg px-2 py-1 text-xs font-semibold text-stellar-600 hover:bg-stellar-500/10 dark:text-stellar-300"><Pencil className="h-3.5 w-3.5" /> Edit</button></div>
