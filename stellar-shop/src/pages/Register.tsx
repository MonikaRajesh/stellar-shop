    ...
    <div className="mx-auto flex max-w-md flex-col px-4 py-12 lg:px-6">
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="rounded-card border border-base bg-elevated p-8 shadow-soft">
        ...
        <div className="mt-6 grid grid-cols-2 gap-2">
          ...
          <Button type="button" variant="outline" disabled={busy} onClick={() => void socialSignup('linkedin_oidc')} className="w-full justify-center gap-2"><FaLinkedinIn /> LinkedIn</Button>
          <Button type="button" variant="outline" disabled={busy} onClick={() => void socialSignup('github')} className="w-full justify-center gap-2"><FaGithub /> GitHub</Button>
          <Button type="button" variant="outline" disabled={busy} onClick={() => void socialSignup('azure')} className="w-full justify-center gap-2"><FaMicrosoft /> Microsoft</Button>
        </div>
        ...
        <p className="mt-4 text-center text-xs text-muted">No OTP verification is used for social sign-in.</p>
